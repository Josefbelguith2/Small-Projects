const address='0x2E5781125aDD1fCb155cc3eCFEe377E71aac3D1C';
const abi=[
	{
		"inputs": [
			{
...
$(function()
{
    ...
    {
        NFT_Game.Endurance.call(0,function(err,result)
        {
            document.getElementById('endurance').innerHTML=result;
            endurance = result;
        });

        NFT_Game.Damage.call(0,function(err,result)
        {
            document.getElementById('damage').innerHTML=result;
        });

        NFT_Game.Magic.call(0,function(err,result)
        {
            document.getElementById('magic').innerHTML=result;
        });

        NFT_Game.LastMeal.call(0,function(err,result)
        {
            lastmeal = result;
        ...
        $("#feed").click(function()
        {
         NFT_Game.Feed.sendTransaction(0,function(err, hash)
         {
